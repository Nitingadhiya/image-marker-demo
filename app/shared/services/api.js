...
const create = (baseURL = AppConfig.apiUrl) => {
  ...
  const getProjectImage = (projectImageId) => api.get('api/project-images/' + projectImageId);
  const getAllProjectImages = (options) => api.get('api/project-images', options);
  const createProjectImage = (projectImage) => api.post('api/project-images', projectImage);
  const updateProjectImage = (projectImage) => api.put(`api/project-images/${projectImage.id}`, projectImage);
  const deleteProjectImage = (projectImageId) => api.delete('api/project-images/' + projectImageId);
