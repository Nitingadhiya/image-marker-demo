...
export const reducers = combineReducers({
  ...
  projectImages: require('../../modules/entities/project-image/project-image.reducer').reducer,
  imageMarkers: require('../../modules/entities/image-marker/image-marker.reducer').reducer,
