...
function ProjectDetailScreen(props) {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.paddedScrollView} testID="projectDetailScrollView">
      ...
      {/* ProjectName Field */}
      <Text style={styles.label}>ProjectName:</Text>
      <Text testID="projectName">{project.projectName}</Text>
      {/* ProjectStartDate Field */}
      <Text style={styles.label}>ProjectStartDate:</Text>
      <Text testID="projectStartDate">{String(project.projectStartDate)}</Text>
